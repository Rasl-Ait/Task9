...
struct FillingData {
  static let data: [ContentType] = [
    ...
    .gallery(Gallery(coverImage: .init("bonsai-0"), title: "Bonsai", images: .init(base: "bonsai", count: 4))),
    .story(Story(coverImage: .init("story-5"), title: .from("s5-title"), text: .from("s5-text"), paths: [.story5path1,.story5path2])),
    .gallery(Gallery(coverImage: .init("turtles-0"), title: "Turtles", images: .init(base: "turtles", count: 9)))
  ]
}
